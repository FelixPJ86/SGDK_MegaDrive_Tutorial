...
int main()
{
    ...
    enemigo[2] = SPR_addSprite(&enemies_sprite, enemigoPosx[2], enemigoPosy[2], TILE_ATTR(PAL3, TRUE, FALSE, FALSE));
    enemigo[3] = SPR_addSprite(&enemies_sprite, enemigoPosx[2] + 10, enemigoPosy[2] - 40, TILE_ATTR(PAL3, TRUE, FALSE, FALSE));
    enemigo[4] = SPR_addSprite(&enemies_sprite, enemigoPosx[2] + 20, enemigoPosy[2] - 30, TILE_ATTR(PAL3, TRUE, FALSE, FALSE));
    enemigo[5] = SPR_addSprite(&enemies_sprite, enemigoPosx[2] + 30, enemigoPosy[2] - 20, TILE_ATTR(PAL3, TRUE, FALSE, FALSE));
    enemigo[6] = SPR_addSprite(&enemies_sprite, enemigoPosx[2] + 40, enemigoPosy[2] - 10, TILE_ATTR(PAL3, TRUE, FALSE, FALSE));
    ...
    SPR_setAnim(enemigo[2], 0);
    SPR_setAnim(enemigo[3], 0);
    SPR_setAnim(enemigo[4], 0);
    SPR_setAnim(enemigo[5], 0);
    SPR_setAnim(enemigo[6], 0);
...
static void mueveEnemigos()
{
    ...
    int velocidadmovx = 1;
    int acelerador = 15;  //modificador el mov sinoidal (CAMBIALO PARA PROBAR)
    ...
    enemigoPosx[2] -= velocidadmovx;
    enemigoPosy[2] = CONST + sinFix16(enemigoPosx[2] * acelerador) * mod_amplitud;
    ...
    SPR_setPosition(enemigo[2], enemigoPosx[1]+20, enemigoPosy[1]-20);
    SPR_setPosition(enemigo[3], enemigoPosx[1]+40, enemigoPosy[1]-30);
    SPR_setPosition(enemigo[4], enemigoPosx[1]+80, enemigoPosy[1]-40);
    SPR_setPosition(enemigo[5], enemigoPosx[1]+100, enemigoPosy[1]-50);
    SPR_setPosition(enemigo[6], enemigoPosx[1]+120, enemigoPosy[1]-80);
}
