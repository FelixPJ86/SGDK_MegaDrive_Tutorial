...
int main()
{
  ...
  VDP_drawImageEx(BG_A, &moon, TILE_ATTR_FULL(PAL0, 0, 0, 0, ind), 3, 3, 0, CPU);
    //carga la imagen en VRAM y la dibuja en pantalla en la posición (3,3)
  VDP_drawImageEx(BG_A, &moon, TILE_ATTR_FULL(PAL0, 0, 0, 0, ind), 10, 10, 0, CPU);
   VDP_drawImageEx(BG_A, &moon, TILE_ATTR_FULL(PAL0, 0, 0, 0, ind), 20, 20, 0, CPU);
    VDP_drawImageEx(BG_A, &moon, TILE_ATTR_FULL(PAL0, 0, 0, 0, ind), 30, 30, 0, CPU);
     VDP_drawImageEx(BG_A, &moon, TILE_ATTR_FULL(PAL0, 0, 0, 0, ind), 10, 30, 0, CPU);
